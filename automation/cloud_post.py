...
# 【2026-08-29 konan指示「7:00、12:00、19:00にしろ。あわせろ。2本のやつは昼と夜ね」】
# IGは2本枠なので 12時(昼)と19時(夜)。
# 【2026-09-23 konan指示「6時 12時 18時 で 1日3投稿にしてスレッドも」】全媒体の先頭3枠を 6/12/18 に揃える。
# 旧 7/12/19(2026-08-29)は撤回。cron は :17/:47 なので、実際の投稿は各時刻の17分ごろ。
IG_HOUR_RANK = [6, 12, 18, 19, 7, 20, 11, 21, 8, 13, 22, 10, 17, 9, 16, 23, 15, 14]
...
TH_HOUR_RANK = [6, 12, 18, 19, 7, 21, 8, 22, 13, 20, 23, 9, 14, 17, 11, 10, 16, 15, 0, 1, 2, 3, 4, 5]
...
# 【2026-08-29 konan指示「7:00、12:00、19:00にしろ。あわせろ。2本のやつは昼と夜ね」】
# 全媒体で時刻を揃える。2本枠(YT・IG)は 12時と19時。曜日で変えるのもやめる(揃わなくなるため)。
YT_HOUR_RANK = [6, 12, 18, 19, 7, 20, 17, 21, 8, 13, 22, 11, 16, 23, 10, 15, 9, 14]
